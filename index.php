...
if(!isset($_SESSION['steamid'])) {
    echo "<div style='margin: 30px auto; padding-bottom: 153px; padding-top: 50px; text-align: center;'><h3><b>Welcome</b></h3>
    <h4><i>Please login in order to donate.</i></h4>
    <br />
  ...
  <span style='float:right;'><?php logoutbutton(); ?></span>
    <div style='margin: 30px auto; padding-bottom: 81px; text-align: center;'><br />
      <h3><b>Home</b></h3>
      <h4><i>This is the main-page.</i></h4>
      <br />
      <div class="header-stroke"></div>
      <br />
      <span style='float:center;'><h3><b>Welcome, <?=$steamprofile['personaname']?>!</b></h3>
      <h4>Please select an action above.</h4></span>
    </div>
		<?php
		}
		?>
